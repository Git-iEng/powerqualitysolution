...
def request_demo_view(request):
    ...
    subject = "New Power quality Solution Inquiry Request"
    text_body = (
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">Power quality Solution Inquiry Request</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        text_body = "\n".join(
            [
                "New Power quality Solution Inquiry Request:",
